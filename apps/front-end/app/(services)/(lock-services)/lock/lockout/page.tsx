        ...
        items={[
          {
            ...
            description: <>Call our direct line at <a href="tel:+6492431404" className="text-brand-accent underline hover:text-brand-accent/80 transition-colors">+64 9 243 1404</a>. We strictly prioritise emergency maintenance requests and dispatch our highly trained team promptly to your specific location anywhere in Auckland.</>
          },
          {
