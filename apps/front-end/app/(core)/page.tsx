...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Commercial & Residential Repair and Maintenance | Falcon Access',
    description: 'Trusted commercial and residential repair and maintenance experts serving homeowners and businesses across New Zealand. Available 24/7.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row-reverse gap-16 items-center">
            ...
            <div className="w-full md:w-1/2">
              ...
              <Link href="/lockout" className="inline-block bg-brand-primary text-white px-8 py-4 rounded-lg font-bold hover:-translate-y-1 hover:shadow-md transition-all duration-200">
                View Lock Services
              </Link>
            </div>
          </div>
