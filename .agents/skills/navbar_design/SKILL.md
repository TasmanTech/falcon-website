...
4. **Bottom-Pinned CTA**: The primary CTA (e.g., Contact Us / Get a Quote button) in the mobile menu must always be pushed to the absolute bottom of the dropdown using `mt-auto mb-4`.
